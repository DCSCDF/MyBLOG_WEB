                        ...
                        <div v-if="showReplyForm" class="mt-6">
                                ...
                                <div v-if="!isLoggedIn" class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        <div>
                                                ...
                                                <input
                                                    v-model="localReplyForm.username"
                                        ...
                                        <div>
                                                ...
                                                <input
                                                    v-model="localReplyForm.avatarUrl"
                                                    class="antd-input w-full px-3 py-2 text-sm rounded-md border-[1.6px] border-gray-200"
                                        ...
                                        <div>
                                                ...
                                                <input
                                                    v-model="localReplyForm.website"
                                                    class="antd-input w-full px-3 py-2 text-sm rounded-md border-[1.6px] border-gray-200"
							...
							{{ currentUser?.nickname || currentUser?.username }}
                                ...
                                <div class="mb-4">
                                        <label
                                            class="block text-xs font-bold text-secondary uppercase tracking-wider mb-1.5 ml-0.5">
                                                回复 @{{ comment.username }}
                                        </label>
                                        <textarea
                                            v-model="localReplyForm.content"
